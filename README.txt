...
-It requires some manual setup to be used 
...
Compile and run.
 ...
 - Create and clear table buttons for fusion table. Note that clear doesn't remove it from your Google drive just yet.
 Tap create, this will add a table in your Google drive named with the current day. 
 From that moment you are all set.
 
 - You should then be able to use interface, try testing taping dispersion button. If you haven't logged to your Google account before
 this will happen now.
 
 If you activate the service by tapping Turn service on toogle, Alohar tech will start working, meaning your location will be 
 attached to event generated by pressing buttons.
 Just tap the same button again to end tracking. IT IS IMPORTANT TO REMEMBER TO DO IT WHEN YOU'RE DONE.
